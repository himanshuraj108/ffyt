      ...
      <div className="flex flex-col w-full max-w-md mx-auto px-4">
        <div className="relative w-full">
          ...
          <div className="mt-6 text-center">
            <Link
              href="/status"
              className="inline-block bg-red-500 text-white px-6 py-3 rounded-full text-lg font-semibold shadow-md hover:bg-blue-700 transform hover:scale-105 transition-all duration-300 animate-pulse"
            >
              CHECK YOUR STATUS
            </Link>
          </div>
        ...
        >
          ...
          <div className="w-full flex justify-center">
            {loading ? (
              ...
              <button
                type="submit"
                className="w-full max-w-[200px] bg-blue-600 text-xl font-bold text-white py-3 px-8 rounded-full hover:bg-blue-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl active:scale-95"
              >
                ADD
              </button>
            )}
