      ...
      <div className="flex flex-col w-full max-w-md mx-auto px-4">
        <div className="relative w-full">
          ...
          <div className="mt-6 text-center">
            <Link
              href="/status"
              className="inline-block bg-red-600 text-white px-6 py-3 rounded-full text-lg font-semibold shadow-md hover:bg-blue-700 transform hover:scale-105 transition-all duration-300 animate-pulse"
            >
              CHECK YOUR STATUS
            </Link>
          </div>
